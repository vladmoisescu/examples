...
require (
	...
	github.com/danielvladco/k8s-vnet v0.0.0-20200506131015-b45924ffcf88
...
replace (
	...
	github.com/networkservicemesh/networkservicemesh/forwarder => ../networkservicemesh/forwarder
	github.com/networkservicemesh/networkservicemesh/forwarder/api => ../networkservicemesh/forwarder/api
	github.com/networkservicemesh/networkservicemesh/k8s => ../networkservicemesh/k8s
	github.com/networkservicemesh/networkservicemesh/k8s/api => ../networkservicemesh/k8s/api
	github.com/networkservicemesh/networkservicemesh/k8s/pkg/apis => ../networkservicemesh/k8s/pkg/apis
	...
	github.com/networkservicemesh/networkservicemesh/side-cars => ../networkservicemesh/side-cars
	github.com/networkservicemesh/networkservicemesh/test => ../networkservicemesh/test
